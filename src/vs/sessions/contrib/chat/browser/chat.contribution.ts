...
import { IViewContainersRegistry, IViewsRegistry, ViewContainerLocation, Extensions as ViewExtensions } from '../../../../workbench/common/views.js';
...
class EnsureChatBarActiveViewContribution implements IWorkbenchContribution {
	static ID = 'sessions.ensureChatBarActiveView';

	constructor(
		@IPaneCompositePartService paneCompositeService: IPaneCompositePartService,
	) {
		// Force switch away from stale placeholder panels (e.g. "Drag a view here")
		// and always open the registered Chat container.
		void paneCompositeService.openPaneComposite(ChatViewContainerId, ViewContainerLocation.ChatBar);
	}
}
...
registerWorkbenchContribution2(EnsureChatBarActiveViewContribution.ID, EnsureChatBarActiveViewContribution, WorkbenchPhase.AfterRestored);
