...
/** Plain JS vendored under src/ is not emitted by the TS compiler; ensure out/ always contains these runtime modules. */
export const copyVendorJsTask = task.define('copy-vendor-js', () => {
	return gulp
		.src(
			[
